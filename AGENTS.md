...
| J2 GY-87 1×8 排母 | `Connector_PinSocket_2.54mm:PinSocket_1x08_P2.54mm_Vertical` | Pin1=DRDY … Pin8=VCC_IN，见 HARDWARE.md |
...
- [x] PCB 布局 v0.4 (80×50mm, J1 2×15 + J2 1×8)
- [x] 固件 GY-87 杜邦线联调通过
- [ ] **J2 改 GY-87 引脚走线**（v0.5，当前 v0.4 不可直插 GY-87）
